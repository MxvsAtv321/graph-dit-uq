...
class GraphDiTWrapper(BaseModelWrapper):
    ...
    def train(self, dataset, epochs=1, batch_size=128, lr=1e-4, 
              log_every_n_steps=50, log_wandb=False) -> Dict[str, float]:
    ...
    def generate(self, batch_size=100) -> List[str]:
        ...
        dummy_smiles = [
            "CCO", "CCCO", "CCCC", "C1=CC=CC=C1", "CC(C)C",
            "CCOC", "CCCCCC", "C1CCCCC1", "CC(C)(C)C", "CCOCC"
        ]
