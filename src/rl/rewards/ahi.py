...
def compute_hypervolume(
    pareto_front: List[Dict[str, float]], reference_point: Optional[List[float]] = None
) -> float:
    """
...
def update_pareto_front(
    pareto_front: List[Dict[str, float]], new_point: Dict[str, float]
) -> List[Dict[str, float]]:
    """
...
def adaptive_hypervolume_reward(
    molecule: str,
